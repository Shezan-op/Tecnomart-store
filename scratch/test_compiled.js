 ...
 */
function getCompatibleMotherboards(cpu) {
 ...
 */
function getCompatibleMemory(motherboard) {
 ...
 */
function getCompatibleStorage(motherboard) {
 ...
 */
function getCompatiblePSUs(cpu, gpu) {
 ...
 */
function getCompatibleCoolers(cpu) {
 ...
 */
function getCompatibleCabinets(motherboard, gpu, cooler) {
 ...
 */
function getOptionsForCategory(category, selections) {
 ...
 */
function getRecommendedItem(category, buildState) {
...
function getTargetSteps(buildType) {
  return buildType === 'complete-setup' 
    ? stepsOrder 
    : stepsOrder.filter(s => s !== 'monitor');
}

function generateRecommendedBuild(buildState) {
