        ...
        <main className="flex-1 py-8 sm:py-16">
          <div className="max-w-[1380px] mx-auto px-3.5 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch mb-12 sm:mb-16">
              ...
              <div className="lg:col-span-7 bg-neutral-950 text-white rounded-3xl p-6 sm:p-12 border border-neutral-800 flex flex-col justify-between shadow-2xl relative overflow-hidden">
                ...
                <div className="space-y-5 relative z-10">
                  ...
                  <h2 className="text-xl sm:text-3xl lg:text-4xl font-black text-white leading-tight uppercase">
              ...
              <div className="lg:col-span-5 bg-neutral-50 rounded-3xl p-5 sm:p-8 border border-neutral-200 shadow-sm flex flex-col justify-between">
                <div>
                  <h3 className="text-base sm:text-lg font-black text-neutral-950 uppercase mb-1">
                    Request Corporate RFQ
                  </h3>
                  <p className="text-xs text-neutral-500 font-medium mb-4 sm:mb-5">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full h-11 px-3 text-base sm:text-sm bg-white border border-neutral-300 rounded-xl outline-none focus:border-amber-500 font-medium shadow-xs"
                      >
