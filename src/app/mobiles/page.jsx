...
import { ShoppingBag, Check, ShieldCheck, Truck, RotateCcw, ChevronRight, SlidersHorizontal, ArrowDownAZ, Star } from 'lucide-react';
          ...
          <div className="max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8 mb-10">
              {displayedMobiles.map((item, idx) => {
                ...
                return (
                  <BlurRevealBox key={item.id} delay={idx * 0.05} yOffset={20}>
                    <Link
            ...
            {hasMore && (
              <div className="text-center pt-2">
                ...
                >
                  View More Phones ({filteredAndSortedMobiles.length - visibleCount} More)
                </button>
              </div>
            )}
