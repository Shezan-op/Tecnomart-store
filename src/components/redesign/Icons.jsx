...
// Official Gold TecnoMart Wings Logo matching the screenshot exactly
export function TecnoMartLogo({ className = "w-9 h-9", textClass = "text-black", subtitleClass = "text-neutral-500" }) {
  return (
    <div className="flex items-center gap-2.5 select-none cursor-pointer group">
      ...
      >
        <path
          d="M30 4L38 20H48L40 30L44 46L30 36L16 46L20 30L12 20H22L30 4Z"
          fill="url(#goldGrad)"
        />
        {/* Left Wing Feathers */}
        <path
          d="M8 12C16 13 22 18 26 24L23 27C19 22 14 18 8 17V12Z"
          fill="#F59E0B"
        />
        <path
          d="M2 20C12 21 18 27 22 34L19 37C15 31 10 26 2 25V20Z"
          fill="#D97706"
        />
        {/* Right Wing Feathers */}
        <path
          d="M52 12C44 13 38 18 34 24L37 27C41 22 46 18 52 17V12Z"
          fill="#F59E0B"
        />
        <path
          d="M58 20C48 21 42 27 38 34L41 37C45 31 50 26 58 25V20Z"
          fill="#D97706"
        />
        {/* Center Vertical Core Line */}
        <path d="M29 20H31V40H29V20Z" fill="#B45309" />
        <defs>
          <linearGradient id="goldGrad" x1="12" y1="4" x2="48" y2="46" gradientUnits="userSpaceOnUse">
